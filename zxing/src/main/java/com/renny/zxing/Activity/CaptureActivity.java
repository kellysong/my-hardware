...
//    private TranslateAnimation translateAnimation;
    ...
    private void initScan() {
        ...
        String scan_title = intent.getStringExtra("scan_title");
        tv_scan.setText(TextUtils.isEmpty(scan_title) ? "扫一扫" : scan_title);
        scanPreview = (SurfaceView) findViewById(R.id.capture_preview);
        scanContainer = (RelativeLayout) findViewById(R.id.capture_container);
        scanCropView = (RelativeLayout) findViewById(R.id.capture_crop_view);
        scanLine = (ImageView) findViewById(R.id.iv_scan_line);
...
//        options.inJustDecodeBounds = true; // 先获取原大小
    ...
    public String getPath(final Context context, final Uri uri) {
        ...
        // DocumentProvider
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {//4.4及以上
